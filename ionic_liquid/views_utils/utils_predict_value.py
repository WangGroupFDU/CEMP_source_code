...
MODEL_PATH="/path/to/example/ionic_liquid/test_box/generate_IL_by_fragments/model/"
IL_ECW_xgb_model_path = os.path.join(MODEL_PATH, 'IL_ECW_xgb_model.joblib')
IL_ECW_xgb_model = joblib.load(IL_ECW_xgb_model_path)

Tm_xgb_model_path = os.path.join(MODEL_PATH,"Tm_xgb_model.joblib")
Tm_xgb_model = joblib.load(Tm_xgb_model_path)

MLP_model_path = os.path.join(MODEL_PATH,"conductivity_MLP_model.pt")
