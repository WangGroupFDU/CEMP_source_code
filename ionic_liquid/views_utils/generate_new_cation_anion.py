    ...
    for index, row in df_core.iterrows():
        ...
        for combo_indices in backbone_combinations:
            ...
            if filtered_outer_connection_list:
                ...
                ion_connection_and_order_list = outer_connection_and_order_list + inner_connection_and_order_list 
...
def generate_new_cation_anion(cation_core_excel, anion_core_excel, cation_backbone_excel, anion_backbone_excel, cation_output_csv, anion_output_csv):
