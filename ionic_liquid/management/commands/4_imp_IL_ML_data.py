...
from ionic_liquid.models import IL_ML_data
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        IL_ML_data.objects.all().delete()

        
        df = pd.read_csv('ionic_liquid/management/commands/Ionic_Liquid_database_total_100000.csv')
