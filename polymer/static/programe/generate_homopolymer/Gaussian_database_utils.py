"""Public pseudocode module for polymer/static/programe/generate_homopolymer/Gaussian_database_utils.py.
...
WORKFLOW_PATH = 'polymer/static/programe/generate_homopolymer/Gaussian_database_utils.py'
PSEUDOCODE_ONLY = True
PSEUDOCODE_STEPS = (
    'Identify the CEMP workflow context for `polymer/static/programe/generate_homopolymer/Gaussian_database_utils.py`.',
