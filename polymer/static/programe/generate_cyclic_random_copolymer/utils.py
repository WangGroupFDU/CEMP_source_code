"""Public pseudocode module for polymer/static/programe/generate_cyclic_random_copolymer/utils.py.
...
WORKFLOW_NAME = 'utils'
WORKFLOW_PATH = 'polymer/static/programe/generate_cyclic_random_copolymer/utils.py'
PSEUDOCODE_ONLY = True
PSEUDOCODE_STEPS = (
    'Identify the CEMP workflow context for `polymer/static/programe/generate_cyclic_random_copolymer/utils.py`.',
