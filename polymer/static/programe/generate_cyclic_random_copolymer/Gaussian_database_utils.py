"""Public pseudocode module for polymer/static/programe/generate_cyclic_random_copolymer/Gaussian_database_utils.py.

Workflow family: generate cyclic random copolymer
...
WORKFLOW_PATH = 'polymer/static/programe/generate_cyclic_random_copolymer/Gaussian_database_utils.py'
PSEUDOCODE_ONLY = True
PSEUDOCODE_STEPS = (
    'Identify the CEMP workflow context for `polymer/static/programe/generate_cyclic_random_copolymer/Gaussian_database_utils.py`.',
