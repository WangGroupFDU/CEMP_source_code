...
class TaskStatusEmailCronJob(CronJobBase):
    ...
    def do(self):
        ...
        for task in tasks:
            ...
            Please note that the data will be stored for 30 days only. We encourage you to log in to the CEMP platform (http://localhost:8000) and manage your task as soon as possible.
