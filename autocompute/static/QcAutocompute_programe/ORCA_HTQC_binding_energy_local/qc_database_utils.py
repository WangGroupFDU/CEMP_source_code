"""Public pseudocode module for autocompute/static/QcAutocompute_programe/ORCA_HTQC_binding_energy_local/qc_database_utils.py.

Workflow family: QcAutocompute programe
Workflow role: prepare component and complex calculations and derive binding energies
...
WORKFLOW_PATH = 'autocompute/static/QcAutocompute_programe/ORCA_HTQC_binding_energy_local/qc_database_utils.py'
PSEUDOCODE_ONLY = True
PSEUDOCODE_STEPS = (
    'Identify the CEMP workflow context for `autocompute/static/QcAutocompute_programe/ORCA_HTQC_binding_energy_local/qc_database_utils.py`.',
    ...
    'Execute the high-level workflow role: prepare component and complex calculations and derive binding energies.',
