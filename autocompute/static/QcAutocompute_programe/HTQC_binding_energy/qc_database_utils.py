"""Public pseudocode module for autocompute/static/QcAutocompute_programe/HTQC_binding_energy/qc_database_utils.py.
...
WORKFLOW_PATH = 'autocompute/static/QcAutocompute_programe/HTQC_binding_energy/qc_database_utils.py'
PSEUDOCODE_ONLY = True
PSEUDOCODE_STEPS = (
    'Identify the CEMP workflow context for `autocompute/static/QcAutocompute_programe/HTQC_binding_energy/qc_database_utils.py`.',
